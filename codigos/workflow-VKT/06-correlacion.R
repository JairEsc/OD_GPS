...
#Para Roberto
list.files("outputs/VKT/",pattern = "conteo_",full.names = T) |> lapply(read.csv)->conteo_hogares
conteo_hogares=do.call(rbind,conteo_hogares)
...
conteo_hogares_metricas=conteo_hogares_metricas |> 
  dplyr::filter(POB1>100 & conteo>20)
